          ...
          <CardContent className="pt-6 space-y-8 text-gray-700 leading-relaxed">
            <section>
              <p>
                ...
                本サービスは第三者向けの広告を配信しておらず、広告目的でのトラッキングや
                個人情報の第三者マーケターへの提供は一切行いません。本プライバシーポリシーは、
                本サービスがどのような情報を収集し、どのように利用・保管・共有するかについて
                説明するものです。本サービスはスウェーデン（EU）にお住まいの方を主な対象と
                しており、EU一般データ保護規則（GDPR）に配慮した運用に努めています。
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mb-2">
                本サービスは、収集した個人情報を販売・レンタルすることはありません。
              ...
              <p className="mt-2 font-medium text-gray-900">
                他の利用者へのメールアドレスの非開示について
              </p>
              <p className="mt-1">
                他の利用者に対しては、投稿に表示される表示名およびプロフィールで公開設定に
                した情報のみが表示されます。あなたのメールアドレスは、原則として他の利用者
                には一切開示されません。「サイト内メッセージ」機能を使えば、お互いのメール
                アドレスを知らせることなくやり取りができ、信頼できると判断した場合のみ、
                ご自身から相手にメールアドレスを伝えることを選べます。「連絡の受け取り方」の
                設定で、メールアドレスを常に非公開にすることも可能です。
              </p>
            </section>
